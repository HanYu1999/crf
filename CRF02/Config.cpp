...
void Config::SetDefault()
{
	...
	// TODO 2, l1
	this->alpha_edge = 0.002;
	this->alpha_node = 0.001;
...
bool Config::LoadConfig(int argc, char* argv[])
{
	...
	while (i < argc)
	{
		...
		}else if (strcmp(argv[i], "-alpha_edge") == 0){ // TODO 2, l1
			this->alpha_edge = atof(argv[++i]); ++i;
		}else if (strcmp(argv[i], "-alpha_node") == 0){ // TODO 2, l1
			this->alpha_node = atof(argv[++i]); ++i;
		}else if (strcmp(argv[i], "-out_dir") == 0){ // TODO 3, management
