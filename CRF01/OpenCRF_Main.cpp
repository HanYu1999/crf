...
{
    char str[] = "OpenCRF.exe -est -niter 200 -gradientstep 0.01 -trainfile /Users/athena/CLionProjects/ForCRFNew/CRF/OpenCRF/testdata/cora_123class.txt -dstmodel model.txt";
    argc = split(str, argv);
