...
void Config::SetDefault()
{
	...
	this->out_dir = "./"; // TODO out_dir
	this->src_dir = "./"; // TODO analyse
	this->is_write_analyse = false; // TODO analyse

	this->is_priorkl_bigger_than_msgkl = -1;
}
...
bool Config::LoadConfig(int argc, char* argv[])
{
	...
	while (i < argc)
	{
		...
		}else if (strcmp(argv[i], "-out_dir") == 0) // TODO out_dir
		{
			this->out_dir = argv[++i]; ++i;
		}else if (strcmp(argv[i], "-analyse") == 0){ // TODO 5, analyse
			this->is_write_analyse = true;
			this->max_iter = 1;
			++i;
		}else if (strcmp(argv[i], "-src_dir") == 0){ // TODO 5, analyse src
			this->src_dir = argv[++i];
			++i;
		}else if (strcmp(argv[i], "-pbm") == 0){  // TODO 1, compare
         	        this->is_priorkl_bigger_than_msgkl = 1; ++i;
        	}else if (strcmp(argv[i], "-psm") == 0){  // TODO 1, compare
            		this->is_priorkl_bigger_than_msgkl = 0; ++i;
        	}
		else ++i;
	}
	return 1;
